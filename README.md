...
APIFY_IDEALISTA_DESIRED_RESULTS=180
APIFY_IDEALISTA_MAX_RESULTS_PER_SEARCH=100
APIFY_IDEALISTA_SEGMENTED_SEARCH=true
APIFY_IDEALISTA_CONCURRENCY=3
IDEALISTA_DETAIL_ENRICHMENT_ENABLED=true
PRIVATE_DETAIL_ENRICHMENT_ENABLED=true
PRIVATE_DETAIL_ENRICHMENT_MAX_RESULTS=80
PARTICULAR_CANDIDATES_ENABLED=true
PORT=3000
```
5. **Deploy**.
